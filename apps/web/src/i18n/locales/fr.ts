...
const fr: SiteContent = {
  ...
  shop: {
    ...
    orderStickers: "Commander des étiquettes d'identification",
  ...
  report: {
    ...
    description: "Signalez un bien volé pour mettre à jour son statut dans le registre.",
    successHeading: "Vol déclaré",
    successDescription: "Votre déclaration a été enregistrée. Le statut du bien a été mis à jour dans le registre.",
    noActiveItems: "Aucun bien actif à déclarer. Enregistrez d'abord un bien.",
    itemLabel: "Bien concerné",
    itemPlaceholder: "Sélectionnez un bien",
    policeReportLabel: "Numéro de rapport de police",
    theftDateLabel: "Date du vol",
    theftLocationLabel: "Lieu du vol",
    descriptionLabel: "Description des circonstances",
    submitButton: "Déclarer le vol",
    submitting: "Envoi...",
  },
  lookup: {
  ...
  scan: {
    ...
    notDistributed: "Ce code n'a pas encore été distribué.",
    voided: "Ce code n'est plus valide. Contactez le support.",
    yourItem: "Votre bien",
    ...
    notYours: "Ce code ne vous appartient pas.",
    loginToReclaim: "Si ce code vous appartient, connectez-vous pour le réclamer.",
    notAssignedYet: "Ce code a été distribué mais n'est pas encore associé à un bien.",
    pickItemLabel: "À quel bien voulez-vous l'associer ?",
    pickItemPlaceholder: "Sélectionner un bien",
    noItemsToLink: "Vous n'avez aucun bien sans code. Enregistrez d'abord un bien.",
    tryAnother: "Chercher un autre code",
  },
  partners: {
  ...
  insurance: {
    ...
    moreDescription: "Ouvrez la liste complète pour choisir un autre assureur.",
    composerHeading: "Préparer votre demande",
    composerDescription: "Votre sélection apparaît ici. Vous pouvez aussi utiliser la liste complète pour choisir un autre assureur.",
    selectedSummary: "Assureur sélectionné : {{insurer}}",
  ...
  admin: {
    ...
    dashboard: {
      ...
      totalItems: "Biens enregistrés",
      ordersCompleted: "Commandes",
      revenue: "Revenus",
      chartsTitle: "Analytiques",
      ...
      axisCount: "Nombre",
      axisRevenue: "$ CAD",
      axisDayOfMonth: "Jour du mois",
      axisWeekNumber: "Semaine",
      axisMonth: "Mois",
      axisItemCount: "Nombre de biens",
      serverMetrics: "Métriques serveur",
      live: "EN DIRECT",
      cpu: "CPU",
      ram: "RAM",
      nodeHeap: "Node Heap",
    ...
    products: {
      ...
      inactive: "Inactif",
      sortOrder: "Ordre",
      customMechanic: "Mécanique spéciale",
      ...
      featuresFr: "Caractéristiques (FR)",
      featuresEn: "Caractéristiques (EN)",
