...
const fr: SiteContent = {
  ...
  auth: {
    ...
    oauthNoEmail: "Aucune adresse courriel associée à ce compte.",
    oauthEmailPrompt: "Veuillez entrer votre adresse courriel pour compléter la connexion.",
    socialAccountError: "Ce compte utilise une connexion Google ou Microsoft.",
  ...
  settings: {
    ...
    communicationDescription: "Choisissez la langue pour les courriels et les notifications.",
  ...
  archive: {
    ...
    modalTitle: "Archiver le bien",
    modalDescription: "Pourquoi souhaitez-vous archiver ce bien ?",
    reasons: {
      destroyed: "Détruit",
      lost: "Perdu",
      discarded: "Jeté",
    ...
    customReasonPlaceholder: "Précisez la raison…",
    confirmButton: "Archiver",
    archiving: "Archivage…",
    cancelButton: "Annuler",
    stolenWarning: "Un bien déclaré volé ne peut pas être archivé.",
    archivedItems: "Biens archivés",
    archivedOn: "Archivé le",
    reason: "Raison",
    noArchivedItems: "Aucun bien archivé.",
  },
  transfer: {
    button: "Transférer ce bien",
  ...
  partners: {
    ...
    citizenAdvantages: [
      ...
      { title: "Éviter d'acheter un bien provenant d'un vol", text: "La consultation du registre permet de réduire les risques d'acheter involontairement un objet volé." },
      { title: "Acheter en toute confiance sur le marché de l'occasion", text: "Le registre agit comme un outil de vérification qui sécurise les transactions entre particuliers." },
      { title: "Vérifier l'identité du propriétaire d'un bien", text: "Dans certains cas, il est possible de confirmer que la personne qui vend le bien est bien le propriétaire enregistré." },
      { title: "Réduire les risques de fraude", text: "Le registre aide à détecter les biens suspectés d'avoir été obtenus illégalement." },
      { title: "Protéger son argent", text: "Un citoyen évite de payer pour un objet qui pourrait être saisi par la police s'il est déclaré volé." },
      { title: "Faciliter la restitution d'un bien trouvé", text: "Si un citoyen retrouve un objet (ex. vélo, outil, appareil), il peut consulter le registre pour tenter d'identifier le propriétaire." },
      { title: "Contribuer à réduire le marché noir", text: "La consultation du registre décourage la revente de biens volés et aide à lutter contre le vol." },
