...
const en: SiteContent = {
  ...
  shop: {
    ...
    orderStickers: "Order identification stickers",
  ...
  report: {
    ...
    description: "Report a stolen item to update its status in the registry.",
    successHeading: "Theft reported",
    successDescription: "Your report has been recorded. The item's status has been updated in the registry.",
    noActiveItems: "No active items to report. Register an item first.",
    itemLabel: "Item concerned",
    itemPlaceholder: "Select an item",
    policeReportLabel: "Police report number",
    theftDateLabel: "Theft date",
    theftLocationLabel: "Theft location",
    descriptionLabel: "Description of circumstances",
    submitButton: "Report theft",
  ...
  scan: {
    ...
    notDistributed: "This code has not been distributed yet.",
    voided: "This code is no longer valid. Contact support.",
    yourItem: "Your item",
    viewItem: "View item",
    ...
    assignButton: "Assign",
    notYours: "This code does not belong to you.",
    loginToReclaim: "If this code is yours, log in to claim it.",
    notAssignedYet: "This code has been distributed but not yet linked to an item.",
    pickItemLabel: "Which item do you want to link it to?",
    pickItemPlaceholder: "Select an item",
    noItemsToLink: "You have no unlinked items. Register an item first.",
    tryAnother: "Look up another",
  },
  partners: {
  ...
  insurance: {
    ...
    moreDescription: "Open the full list to choose another insurer.",
    composerHeading: "Prepare your request",
    composerDescription: "Your selection appears here. You can also use the full list to choose another insurer.",
    selectedSummary: "Selected insurer: {{insurer}}",
