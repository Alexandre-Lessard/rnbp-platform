...
| **order_items** | Line items within an order. Links to the order and optionally to an item. Tracks the assigned `rnbpNumber`, product type, quantity, and unit price in cents. |
